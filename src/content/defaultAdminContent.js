...
export const DEFAULT_ADMIN_CONTENT = {
  ...
  homepageSections: {
    learnAi: { name: "AI Launchpad Tracks", heading: "AI", accentHeading: "Launchpad", description: "Structured learning paths with curated courses, projects & assessments.", ctaLabel: "View Tracks", ctaHref: "#classroom" },
