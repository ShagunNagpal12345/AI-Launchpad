...
export const DEFAULT_ADMIN_CONTENT = {
  ...
  ecosystem: {
    ...
    items: [
      ...
      },
      {
        ...
        cta: "Practice Now",
        href: "/learning-arena#practice-showcase",
  ...
  homepageSections: {
    learnAi: { name: "AI Launchpad Tracks", heading: "AI", accentHeading: "Launchpad", description: "Structured learning paths with curated courses, projects & assessments.", ctaLabel: "Enter Classroom", ctaHref: "/learn#classroom-page-top" },
    liveExperts: { name: "Live Experts", heading: "Learn Live with Our", accentHeading: "Experts", description: "Live classes, doubt support, office hours, and mentorship to help you move faster.", ctaLabel: "Connect with an Expert", ctaHref: "https://www.skool.com/the-agent-lab-3899" },
    weeklyAssignments: { name: "Weekly Assignments", heading: "Weekly Assignments &", accentHeading: "Practice", description: "Learn by doing with hands-on assignments, quizzes, deadlines, and expert feedback.", ctaLabel: "View Assignments in Action", ctaHref: "" },
    resources: { name: "Learning Materials", heading: "Latest AI Learning", accentHeading: "Materials", description: "", ctaLabel: "Explore Learning", ctaHref: "#all-resources" },
    ...
    aiTools: { name: "AI Interactive Tools", heading: "AI Tools &", accentHeading: "Interactive Experiences", description: "Learn by building with powerful AI tools, creative playgrounds, and guided utilities.", ctaLabel: "", ctaHref: "" },
